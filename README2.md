...
1. Create your own branch: `git checkout -b CHANGEYOURBRANCHNAMEHERE`
...
1. If everything works correctly, we can update & push it to the master branch for anyone to use.
    - `git checkout master`
